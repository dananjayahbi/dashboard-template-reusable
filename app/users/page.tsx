...
export default function UsersPage() {
  ...
  const handleUpdateUser = async () => {
    ...
    try {
      ...
      if (editUserForm.name !== userToEdit.name)
        updateData.name = editUserForm.name;
      if (editUserForm.email !== userToEdit.email)
        updateData.email = editUserForm.email;
      if (editUserForm.image !== userToEdit.image)
        updateData.image = editUserForm.image;
  ...
  const handleStatusChange = async (
    ...
    try {
      setLoading(true);
      console.log(
        `UsersPage.handleStatusChange called for user ${userId} status to ${newStatus}`
      );
        ...
        <DialogContent>
          ...
          >
            ...
            <TextField
              ...
              onChange={(e) =>
                setEditUserForm({ ...editUserForm, image: e.target.value })
              }
              fullWidth
              disabled={formSubmitting}
              placeholder="https://example.com/profile.jpg"
